...
async def process_update(update: dict):
    ...
    try:
        ...
        if "message" in update:
            ...
            try:
                # Fetch message properly (resolves peer_id automatically)
                ...
                logger.warning(f"PeerIdInvalid for chat {chat_id} - user needs to /start bot first")
            except Exception as e:
        ...
        # Handle edited messages
            ...
            try:
                ...
                logger.warning(f"PeerIdInvalid for edited message - user needs to /start bot first")
            except Exception as e:
                logger.error(f"Edited message error: {e}", exc_info=True)

        # Handle callback queries (buttons)
        elif "callback_query" in update:
            # Callback queries work differently - handle as needed
...
class MN_Bot(Client):
    ...
    async def start(self):
        ...
        # Pre-resolve owner peer to avoid PeerIdInvalid
        try:
